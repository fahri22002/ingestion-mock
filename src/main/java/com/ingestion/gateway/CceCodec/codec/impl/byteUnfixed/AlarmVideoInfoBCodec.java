...
@ApplicationScoped
public class AlarmVideoInfoBCodec extends AbstractByteUnfixedCodec<AlarmVideoInfoDto> {

    private static final Logger LOG = Logger.getLogger(AlarmVideoInfoBCodec.class);
    ...
    public String getParameterName() {
        return "Alarm video information_B";
    }
