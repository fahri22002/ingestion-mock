...
import com.ingestion.gateway.Jtt808Codec.dto.impl.core.FileUploadCompletedMessageDto;
...
@ApplicationScoped
public class FileUploadCompletedMessageCodec implements Jtt808MessageCodec<FileUploadCompletedMessageDto> {

    private static final Logger LOG = Logger.getLogger(FileUploadCompletedMessageCodec.class);
    ...
    public int getSupportedMessageId() {
        return 0x1212; // ID untuk File Upload Completed Message
    }

    @Override
    public Class<FileUploadCompletedMessageDto> getSupportedDtoClass() {
        return FileUploadCompletedMessageDto.class;
    }

    @Override
    public String getCommandName() {
        return "File Upload Completed Message";
    }

    @Override
    public FileUploadCompletedMessageDto decodeBody(byte[] bodyData) {
        ByteBuffer buf = ByteBuffer.wrap(bodyData);
        FileUploadCompletedMessageDto dto = new FileUploadCompletedMessageDto();
        ...
        try {
            ...
            LOG.error("Gagal mengekstrak body File Upload Completed Message", e);
            return null;
        }
        return dto;
    }
    ...
    @Override
    public byte[] encodeValue(FileUploadCompletedMessageDto dto) {
        try {
            ...
            LOG.error("Gagal melakukan encode body File Upload Completed Message", e);
            return new byte[0];
        }
    }
}